local highlights = {
		...
		PmenuSel = {bg = C.ui2_vivid_blue, },
		WildMenu = {fg = C.fg, bg = C.ui2_vivid_blue, },
		...
		QuickFixLine = {bg = C.ui2_vivid_blue, },
		PmenuSbar = {bg = C.alt_bg, },
		PmenuThumb = {bg = C.gray, },
		MatchWord = {style = "underline", },
		MatchParen = {fg = C.hint_vivid_blue, bg = C.bg, style = "underline", },
