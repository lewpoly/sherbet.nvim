local c = require("sherbet.palette")
...
if vim.g.sherbet_italic_keywords then
	italic_keywords = true
end

if vim.g.sherbet_italic_functions then
	italic_functions = true
end

if vim.g.sherbet_italic_comments then
	italic_comments = true
end

if vim.g.sherbet_italic_loops then
	italic_loops = true
end

if vim.g.sherbet_italic_conditionals then
...
theme.set_highlights = function()
	...
	hl(0, "ColorColumn", { fg = "NONE", bg = c.line })
	hl(0, "NormalFloat", { fg = "NONE", bg = c.alt_bg })
	hl(0, "Visual", { fg = "NONE", bg = c.ui_search })
	...
	hl(0, "Search", { fg = c.yellow, bg = c.ui_search })
	hl(0, "IncSearch", { fg = c.yellow, bg = c.ui_search })
	hl(0, "CurSearch", { fg = c.yellow, bg = c.ui_search })
	...
	hl(0, "Number", { fg = c.green, bg = "NONE", bold = true })
	hl(0, "Float", { fg = c.green, bg = "NONE", bold = true })
	hl(0, "Boolean", { fg = c.green, bg = "NONE", bold = true})
	...
	hl(0, "Operator", { fg = c.blue_purple, bg = "NONE" })
	...
	hl(0, "Debug", { fg = c.purple, bg = "NONE" })
	hl(0, "Title", { fg = c.fg, bg = "NONE", bold = false })
	hl(0, "Label", { fg = c.fg, bg = "NONE" })
	hl(0, "SpecialChar", { fg = c.orange, bg = "NONE" })
	hl(0, "Delimiter", { fg = c.blue_purple, bg = "NONE" })
	...
	hl(0, "@constructor", { fg = c.cyan, bg = "NONE" })
	hl(0, "@type", { link = "Type" })
	...
	hl(0, "@punct.delimiter", { link = "Delimiter" })
	hl(0, "@tag.delimiter", { link = "Delimiter" })
	hl(0, "@punct.bracket", { fg = c.cyan, bg = "NONE" })
	hl(0, "@punct.special", { link = "Delimiter" })
	hl(0, "@tag", { link = "Tag" })
	...
	hl(0, "@type.builtin", { fg = c.cyan, bg = "NONE" })
	hl(0, "@annotation", { fg = c.blue, bg = "NONE" })
	hl(0, "@namespace", { fg = c.cyan, bg = "NONE" })
	hl(0, "@symbol", { fg = c.fg, bg = "NONE" })
	hl(0, "@field", { fg = c.yellow, bg = "NONE" })
	hl(0, "@property", { fg = c.yellow, bg = "NONE" })
	...
	hl(0, "TelescopeSelectionCaret", { fg = c.light_gray, bg = c.ui2_blue })
	...
	hl(0, "TelescopePromptTitle", { fg = c.light_gray, bg = "NONE" })
	hl(0, "TelescopePromptPrefix", { fg = c.light_gray, bg = "NONE" })
	hl(0, "TelescopeResultsTitle", { fg = c.light_gray, bg = "NONE" })
	hl(0, "TelescopePreviewTitle", { fg = c.light_gray, bg = "NONE" })
	hl(0, "TelescopePromptCounter", { fg = c.light_gray, bg = "NONE" })
	hl(0, "TelescopePreviewHyphen", { fg = c.light_gray, bg = "NONE" })
	...
	hl(0, "NvimTreeFolderName", { fg = c.yellow, bg = "NONE" })
	hl(0, "NvimTreeOpenedFolderName", { fg = c.yellow, bg = "NONE", bold = true, italic = true })
	...
	hl(0, "NvimTreeCursorLine", { fg = "NONE", bg = c.tree_line })
	...
	hl(0, "CmpItemAbbrMatch", { fg = c.ui_orange, bg = "NONE" })
	hl(0, "CmpItemAbbrMatchFuzzy", { fg = c.ui_orange, bg = "NONE" })
	...
	hl(0, "CmpItemKindVariable", { fg = c.yellow, bg = "NONE" })
	hl(0, "CmpItemKindField", { fg = c.fg, bg = "NONE" })
	hl(0, "CmpItemKindProperty", { fg = c.yellow, bg = "NONE" })
	...
	hl(0, "NavicIconsProperty", { fg = c.yellow, bg = "NONE" })
	hl(0, "NavicIconsField", { fg = c.yellow, bg = "NONE" })
	...
	hl(0, "NavicIconsVariable", { fg = c.yellow, bg = "NONE" })
	hl(0, "NavicIconsConstant", { fg = c.orange, bg = "NONE" })
	hl(0, "NavicIconsString", { fg = c.orange, bg = "NONE" })
	hl(0, "NavicIconsNumber", { fg = c.green, bg = "NONE" })
	hl(0, "NavicIconsBoolean", { fg = c.green, bg = "NONE" })
	...
	hl(0, "htmlTSHead", { fg = c.fg, bg = "NONE" })
	hl(0, "htmlTSTitle", { fg = c.fg, bg = "NONE" })
	hl(0, "htmlTSArg", { fg = c.fg, bg = "NONE" })
	hl(0, "htmlTSTag", { fg = c.blue, bg = "NONE" })
	hl(0, "htmlTSTagN", { fg = c.blue, bg = "NONE" })
	hl(0, "htmlTSURI", { fg = c.cyan, bg = "NONE" })
	hl(0, "htmlTSTagName", { fg = c.blue, bg = "NONE" })
	hl(0, "htmlTSTagDelimiter", { fg = c.alt_fg, bg = "NONE" })
	hl(0, "htmlTSTagAttribute", { fg = c.yellow, bg = "NONE" })
	hl(0, "htmlTSComment", { fg = c.gray, bg = "NONE" })
	hl(0, "htmlTSLink", { fg = c.orange, bg = "NONE", underline = true })
	hl(0, "cssBraces", { fg = c.fg, bg = "NONE" })
	hl(0, "cssInclude", { fg = c.purple, bg = "NONE" })
	hl(0, "cssTagName", { fg = c.yellow, bg = "NONE" })
	hl(0, "cssClassName", { fg = c.purple, bg = "NONE" })
	hl(0, "cssClassNameDot", { fg = c.purple, bg = "NONE" })
	...
	hl(0, "cssCustomProp", { fg = c.light_gray, bg = "NONE" })
	hl(0, "cssFunction", { fg = c.purple, bg = "NONE" })
	hl(0, "cssFunctionName", { fg = c.cyan, bg = "NONE" })
	hl(0, "cssVendor", { fg = c.orange, bg = "NONE" })
	hl(0, "cssValueNumber", { fg = c.green, bg = "NONE" })
	hl(0, "cssValueLength", { fg = c.green, bg = "NONE" })
	hl(0, "cssUnitDecorators", { fg = c.green, bg = "NONE" })
