...
theme.set_highlights = function()
  ...
  hl(0, "cssClassNameDot", { fg = c.orange, bg = "NONE" })
  ...
  hl(0, "cssCustomProp", { fg = c.cyan, bg = "NONE" })
  hl(0, "cssDefinition", { fg = c.fg, bg = "NONE" })
  -- hl(0, "cssTextProp", { fg = c.fg, bg = "NONE" })
  hl(0, "cssAttr", { fg = c.blue, bg = "NONE" })
  hl(0, "cssAttrRegion", { fg = c.blue, bg = "NONE" })
