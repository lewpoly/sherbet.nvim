...
theme.set_highlights = function()
	...
	hl(0, "TSField", { fg = c.yellow, bg = "NONE" })
	hl(0, "TSProperty", { fg = c.yellow, bg = "NONE" })
	hl(0, "TSParameter", { fg = c.yellow, bg = "NONE" })
	hl(0, "TSParameterReference", { fg = c.fg, bg = "NONE" })
	hl(0, "TSAttribute", { fg = c.yellow, bg = "NONE" })
	hl(0, "TSText", { fg = c.fg, bg = "NONE" })
	hl(0, "TSTagAttribute", { fg = c.purple, bg = "NONE", italic = false })
	hl(0, "TSError", { fg = c.error, bg = "NONE" })
	hl(0, "TSWarning", { fg = c.warn, bg = "NONE" })
	hl(0, "TSQueryLinterError", { fg = c.error, bg = "NONE" })
	hl(0, "TSURI", { fg = c.green, bg = "NONE", underline = true })
