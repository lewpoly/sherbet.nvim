...
theme.set_highlights = function()
	...
	hl(0, "Keyword", { fg = c.red, bg = "NONE", italic = italic_keywords })
	hl(0, "Conditional", { fg = c.red, bg = "NONE", italic = italic_conditionals })
	...
	hl(0, "TSPunctBracket", { link = "TSProperty" })
	...
	hl(0, "TSParameter", { fg = c.fg, bg = "NONE" })
