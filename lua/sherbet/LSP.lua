local LSP = {
		...
		LspDiagnosticsHint = {fg = C.fg, },
		LspDiagnosticsUnderlineError = {fg = "NONE", bg = "NONE", sp = C.error_red, undercurl = true},
		LspDiagnosticsUnderlineWarning = {fg = "NONE", bg = "NONE", sp = C.warning_orange, undercurl = true},
		LspDiagnosticsUnderlineInfo = {fg = "NONE", bg = "NONE", sp = C.info_yellow, undercurl = true},
		LspDiagnosticsUnderlineHint = {fg = "NONE", bg = "NONE", sp = C.hint_blue, undercurl = true},
